...
print ('''\033[1;34m   
      ...
      .o.       ooooooooo.   oooooooooooo  o8o                    .o8                     
     .888.      `888   `Y88. `888'     `8  `"'                   "888                     
    .8"888.      888   .d88'  888         oooo  ooo. .oo.    .oooo888   .ooooo.  oooo d8b 
   .8' `888.     888ooo88P'   888oooo8    `888  `888P"Y88b  d88' `888  d88' `88b `888""8P 
  .88ooo8888.    888          888    "     888   888   888  888   888  888ooo888  888     
 .8'     `888.   888          888          888   888   888  888   888  888    .o  888     
o88o     o8888o o888o        o888o        o888o o888o o888o `Y8bod88P" `Y8bod8P' d888b    
                                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
                          \033[37mCreer avec Python \033[91m<3\033[37m Par Sweekzi\033[1;m''')
...
try:
    ...
    if '<html>' in r.text: #if there's an html error page then its not robots.txt
        print ('  \033[1;31m[-]\033[1;m Robots.txt inexistant\n')
...
def get_paths(type):
    try:
        with open('LinkAdminPanel.txt','r') as wordlist: #opens paths.txt and grabs links according to the type arguemnt
